...
(typeof(Func<double, double, double>), function);
        ...
        public List<TempRules> Test2(string finalCode)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < 6*1000; i++)
                {
                    ...
                    tr.ruleRun1 = (Func<DyanmicLoadGenericObject, DyanmicLoadGenericObject>)Delegate.CreateDelegate
                        (typeof(Func<DyanmicLoadGenericObject, DyanmicLoadGenericObject>), r);
    ...
    public class TempRules
    {
        ...
        public Func<DyanmicLoadGenericObject, DyanmicLoadGenericObject> ruleRun1;
    }

    public class DyanmicLoadGenericObject
    {
        public int testInt;
